...
% В дальнейшем расчёты поглощённой мощности по объёму будут осущевлятся в диапазонах $[0,36232\cdot10^{15}, 0,36240\cdot10^{15}]$ c $\tau_{81} = 0,691569$ и $[2,38460\cdot10^{15}, 2,38960\cdot10^{15}]$ с $\tau_{170} = 2,507276$.
